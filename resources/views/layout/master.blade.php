    ...
    <div class="wrapper">
        ...
        <div class="main-header" data-background-color="blue">
            <nav class="sb-topnav navbar navbar-expand">
                <a class="navbar-brand">Marketing Funnel <button class="btn btn-minimize btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button> </a>
                <!-- Navbar Search-->
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="base2">
                                <ul class="nav nav-collapse">
                                    ...
                                    <li>
                                        <a href="{{ route('data') }}"><span class="sub-item">Data Kategori Content</span></a>
                                    </li>
                                    <li>
                                        <a href="{{ route('funnel') }}"><span class="sub-item">Data Marketing Funnel</span></a>
                                    </li>
                                    <li>
                                        <a href="#"><span class="sub-item">Data Engagement</span></a>
                                    </li>
                                    <!-- <li>
                                        <a href="#"><span class="sub-item">Jenis Program Afiliasi</span></a>
                                    </li>
                                    <li>
                                        <a href="#"><span class="sub-item">Data Fee</span></a>
                                    </li>
                                    <li>
                                        <a href="#"><span class="sub-item">Program Afiliasi</span></a>
                                    </li> -->
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="laporan2">
                                <ul class="nav nav-collapse">
                                <li>
                                        <a href="{{ route('cetak_laporan') }}"><span class="sub-item">Laporan Data Engagement</span></a>
                                    </li>
                                </ul>
                            </div>
                        </li>
